 ...
 *
 * The list is maintained by measurement, not by intuition: a corpus of notes a
 * person would type into this app, run through the guard, and every false
 * refusal chased to the word that caused it. Thirty such notes found "decide
 * that now" and "aware that", which is the failure that matters most here,
 * because a guard that refuses ordinary sentences teaches people to phrase
 * things around it and the next thing they phrase around it is a seed word.
 */
